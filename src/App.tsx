      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-lg shadow-md text-center max-w-lg w-full">
          ...
          <p className="mt-2 text-gray-600">
            Supabase client could not be initialized. Please ensure your environment variables are correctly set up in your <code>.env.local</code> file.
          </p>
          <div className="mt-4 text-left bg-gray-100 p-4 rounded-md text-sm text-gray-700">
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li><code>VITE_SUPABASE_URL</code>: Your project's API URL.</li>
              <li><code>VITE_SUPABASE_ANON_KEY</code>: Your project's public anon key.</li>
            </ul>
          </div>
